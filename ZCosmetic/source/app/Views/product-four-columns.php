                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="header-navigation">
                            <ul class="main-nav justify-content-start">
                                ...
                                <li class="has-submenu position-static"><a href="product.php">sản phẩm</a>
                                    <ul class="submenu-nav-mega">
                                        <li><a href="#/" class="mega-title">Skincare</a>
                                            <ul>
                                                <li><a href="pages/ca_faceCleanser.php">Sửa rửa mặt</a></li>
                                                <li><a href="pages/ca_faceMask.php">Mặt nạ</a></li>
                                                <li><a href="pages/ca_serum.php">Serum</a></li>
                                                <li><a href="pages/ca_sunscreen.php">Kem chống nắng</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#/" class="mega-title">Makeup</a>
                                            <ul>
                                                <li><a href="pages/makeup_Face.php">Mặt</a></li>
                                                <li><a href="pages/makeup_Eye.php">Mắt</a></li>
                                                <li><a href="pages/makeup_Lips.php">Môi</a></li>
                                                <li><a href="pages/makeup_Tool.php">Dụng cụ trang điểm</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#/" class="mega-title">Nước hoa</a>
                                            <ul>
                                                <li><a href="pages/perfume_Male.php">Nước hoa nam</a></li>
                                                <li><a href="pages/perfume_Female.php">Nước hoa nữ</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="about-us.php">Giới thiệu</a></li>
                                <li class="has-submenu"><a href="pages/blog.php">Blog</a></li>
                                <li class="has-submenu"><a href="account-login.php">Chăm sóc khách hàng</a>
                                    <ul class="submenu-nav">
                                        <li><a href="account-login.php">Hệ thống cửa hàng</a></li>
