                                ...
                                <tbody>
                                        ...
                                        <td class="product-thumbnail">
                                            <div class="thumb">
                                                <a href="single-product.php">  
                                                    <img src="/brancy/assets/images/shop/cart1.webp" width="68" height="84" alt="Image-HasTech">
                                                </a>
                                            </div>
                                        </td>
                                        <td class="product-name">
                                            <a class="title" href="product-details.php">Condimentum posuere consectetur urna</a>
                                        </td>
                                        ...
                                        <td class="product-thumbnail">
                                            <div class="thumb">
                                                <a href="product-details.php">
                                                    <img src="/brancy/assets/images/shop/cart2.webp" width="68" height="84" alt="Image-HasTech">
                                                </a>
                                            </div>
                                        </td>
                                        <td class="product-name">
                                            <a class="title" href="product-details.php">Kaoreet lobortis sagittis laoreet</a>
                                        </td>
                                        <td class="product-price">
                                    ...
                                    <tr class="tbody-item">
                                        ...
                                        <td class="product-thumbnail">
                                            <div class="thumb">
                                                <a href="product-details.php">
                                                    <img src="/brancy/assets/images/shop/cart3.webp" width="68" height="84" alt="Image-HasTech">
                                                </a>
                                            </div>
                                        </td>
                                        <td class="product-name">
                                            <a class="title" href="product-details.php">Nostrum exercitationem itae ipsum</a>
                                        </td>
                                        <td class="product-price">
                    ...
                    <div class="row">
                            ...
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="index.php">
                                        <img src="/brancy/assets/images/mainlogone.png" width="95" height="68" alt="Logo">
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-5 mt-md-0 mt-9">
                            <div class="widget-item">
                                ...
                                <ul class="widget-nav">
                                    <li><a href="blog.php">Tạp chí làm đẹp</a></li>
                    ...
                    <div class="modal-body">
                        <div class="product-action-view-content">
                            ...
                            <div class="modal-action-product">
                                <div class="thumb">
                                    <img src="/brancy/assets/images/shop/modal1.webp" alt="Organic Food Juice" width="466" height="320">
                                </div>
                ...
                <div class="container pt--0 pb--0">
                    <div class="search-box-form-wrap">
                        <div class="search-note">
                            <p>Nội dung bạn muốn tìm kiếm</p>
                        </div>
                        <form action="#" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="product-single-thumb">
                                            <img src="/brancy/assets/images/shop/quick-view1.webp" width="544" height="560" alt="Image-HasTech">
                                        </div>
            ...
            <div class="offcanvas-body">
                <ul class="aside-cart-product-list">
                    <li class="aside-product-list-item">
                        ...
                        <a href="product-details.php">
                            <img src="/brancy/assets/images/shop/cart1.webp" width="68" height="84" alt="Image">
                    ...
                    <li class="aside-product-list-item">
                        <a href="#/" class="remove">×</a>
                        <a href="product-details.php">
                            <img src="/brancy/assets/images/shop/cart2.webp" width="68" height="84" alt="Image">
                ...
                <a class="btn-total" href="cart.php">Xem giỏ hàng</a>
                <a class="btn-total" href="product-checkout.php">Thanh toán</a>
            </div>
        </aside>
        <!--== End Aside Cart ==-->
        ...
        <aside class="off-canvas-wrapper offcanvas offcanvas-start" tabindex="-1" id="AsideOffcanvasMenu" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <div id="offcanvasNav" class="offcanvas-menu-nav">
                    <ul>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="#">Trang chủ</a>
                            <ul>
                                <li><a href="index.php">Home One</a></li>
                                <li><a href="index-two.php">Home Two</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="about-us.php">Giới thiệu</a></li>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="#">Cửa hàng</a>
                            <ul>
                        ...
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="#">Trang</a>
                            <ul>
                                <li><a href="account-login.php">Tài khoản của tôi</a></li>
                                <li><a href="faq.php">Câu hỏi thường gặp</a></li>
                                <li><a href="page-not-found.php">Page Not Found</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="contact.php">Liên hệ</a></li>
                    </ul>
                </div>
            </div>
        </aside>
