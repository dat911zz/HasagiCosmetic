                    ...
                    <div class="col-5 col-sm-6 col-lg-3">
                        <div class="header-logo">
                            <a href="welcome_message.php">
                                <img class="logo-main" src="../assets/images/mainlogone.png" width="95" height="68" alt="Logo" />
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="header-navigation">
                            <ul class="main-nav justify-content-start">
                                <li class="has-submenu"><a href="welcome_message.php">home</a>
                                    <ul class="submenu-nav">
                                        <li><a href="welcome_message.php">Home One</a></li>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-style1">
                <div class="container">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="welcome_message.php">Home</a></li>
            ...
            <section class="section-space pb-0">
                <div class="container">
                    <div class="blog-detail">
                        <h3 class="blog-detail-title">Lorem ipsum dolor sit amet, ctetur adipiscing elit</h3>
                        <div class="blog-detail-category">
                            <a class="category" href="blog.php">beauty</a>
                            <a class="category" data-bg-color="#957AFF" href="blog.php">Fashion</a>
                        </div>
                        <img class="blog-detail-img mb-7 mb-lg-10" src="../assets/images/blog/blog-detail1.webp" width="1170" height="1012" alt="Image">
                    ...
                    <div class="row justify-content-between align-items-center pt-10 mt-4 section-space">
                        <div class="col-sm-6">
                            <a href="blog-details.php" class="blog-next-previous">
                                <div class="thumb">
                        ...
                        <div class="col-sm-6">
                            <a href="blog-details.php" class="blog-next-previous blog-next">
                                <div class="thumb">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="welcome_message.php">
