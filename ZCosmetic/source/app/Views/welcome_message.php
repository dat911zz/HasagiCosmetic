                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a class="d-block" href="pages/product-details.php">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Readable content DX22</a></h4>
                                <div class="prices">
                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Modern Eye Brush</a></h4>
                                <div class="prices">
                                    <span class="price">$210.00</span>
                                    <span class="price-old">300.00</span>
                                </div>
                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Voyage face cleaner</a></h4>
                                <div class="prices">
                                    <span class="price">$210.00</span>
                                    <span class="price-old">300.00</span>
                                </div>
                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Impulse Duffle</a></h4>
                                <div class="prices">
                                    <span class="price">$210.00</span>
                                    <span class="price-old">300.00</span>
                                </div>
                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Sprite Yoga Straps1</a></h4>
                                <div class="prices">
                                    <span class="price">$210.00</span>
                                    <span class="price-old">300.00</span>
                                </div>
                    ...
                    <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="title"><a href="pages/product-details.php">Fusion facial cream</a></h4>
                                <div class="prices">
                                    <span class="price">$210.00</span>
                                    <span class="price-old">300.00</span>
                                </div>
                ...
                <div class="modal-body">
                    <div class="product-action-view-content">
                        ...
                        <div class="modal-action-product">
                            ...
                            <h4 class="product-name"><a href="pages/product-details.php">Readable content DX22</a></h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="offcanvas-nav-item">Single Product</a>
                                <ul>
                                    ...
                                    <li><a href="pages/product-details.php">Single Product Variable</a></li>
